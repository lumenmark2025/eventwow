...
export function toVenueCardDto(venue, heroPath, supabaseUrl) {
  return {
    ...
    heroImageUrl: heroPath ? getPublicImageUrl(supabaseUrl, "venue-gallery", heroPath) : null,
...
export function toVenueProfileDto(venue, images, supabaseUrl) {
  ...
  return {
    ...
    heroImageUrl: hero ? getPublicImageUrl(supabaseUrl, "venue-gallery", hero.path) : null,
    facilities: Array.isArray(venue.facilities) ? venue.facilities : [],
    gallery: gallery.map((img) => ({
      url: getPublicImageUrl(supabaseUrl, "venue-gallery", img.path),
...
export function toLinkedSupplierDto(supplier, heroPath, perf, supabaseUrl, reviewStats = null) {
  return {
    ...
    heroImageUrl: heroPath ? getPublicImageUrl(supabaseUrl, "supplier-gallery", heroPath) : null,
